            ...
            {currentStep === 0 && (
              <div className="text-center py-8">
                ...
                <p className="font-bold text-lg md:text-xl text-center max-w-3xl mx-auto">
                  Scams are dishonest attempts by cybercriminals to trick you
                  into giving them money, personal information, or access to
                  your devices. They come in many forms, often disguised as
                  legitimate communications. Learning to recognize their tactics
