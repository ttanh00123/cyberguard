...
const commonScams = [
  {
    ...
    description:
      "Fake emails that try to steal your passwords or personal info",
    icon: Mail,
    color: "bg-red-500",
    example: {
      ...
      content:
        "Click here immediately to verify your account or it will be deleted in 24 hours!",
      redFlags: [
        "Urgent language",
        "Misspelled domain",
        "Generic greeting",
  ...
  },
  {
    ...
    description:
      "Scammers pretending to be from Microsoft, Apple, or other companies",
    icon: Phone,
    color: "bg-orange",
    example: {
      scenario: "Pop-up on your computer",
      message:
        "WARNING: Your computer is infected with 5 viruses! Call 1-800-FAKE-HELP now!",
  ...
  },
  {
    ...
    description:
      "Fake contests, friendship requests, and 'get rich quick' schemes",
    icon: Gift,
    color: "bg-hot-pink",
    example: {
      post: "Congratulations! You've won a $1000 gift card! Click to claim!",
      requirement:
        "Share this post and enter your credit card info for 'verification'",
      friend:
        "Attractive stranger wants to be friends and share 'investment tips'",
      redFlags: [
        "Too good to be true",
...
const scamQuizQuestions = [
  {
    question:
      "You receive an email saying your bank account will be closed unless you click a link and log in. What should you do?",
    options: [
    ...
    correct: 2,
    explanation:
      "Always contact your bank directly using their official website or phone number. Never click suspicious links.",
  },
  {
    question:
      "A website offers a new smartphone for $50 and only accepts payment by gift card. What is the safest action?",
    options: [
    ...
    correct: 3,
    explanation:
      "Unusual payment methods and too-good-to-be-true offers are major red flags. Report and avoid such sites.",
  },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-black mb-4 transform -rotate-1">
              COMMON
              <span className="block text-red-500 transform rotate-2">
                SCAMS!
              </span>
            </h1>

            <p className="text-xl md:text-2xl font-bold text-gray-800 max-w-4xl mx-auto">
              Learn to spot the most common online scams and protect yourself
              from cybercriminals! 🕵️‍♂️
            </p>
          </div>
          ...
          {currentStep === 0 && (
            <div className="text-center py-8">
              ...
              <p className="font-bold text-lg md:text-xl text-center max-w-3xl mx-auto">
                Scams are dishonest attempts by cybercriminals to trick you into
                giving them money, personal information, or access to your
                devices. They come in many forms, often disguised as legitimate
                communications. Learning to recognize their tactics is the first
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              {commonScams.map((scam, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`inline-block p-4 ${scam.color} brutalist-border brutalist-shadow-small mb-4`}
                    >
            ...
            <div className="bg-lime-green brutalist-border brutalist-shadow p-8 mb-12 transform -rotate-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {protectionTips.map((tip, index) => (
                  <div
                    key={index}
                    className="bg-white brutalist-border p-4 transform hover:scale-105 transition-transform"
                  >
          ...
          {currentStep === 4 && (
            <div className="text-center py-16">
              ...
              <p className="font-bold text-lg md:text-xl text-center max-w-3xl mx-auto mb-8">
                You've now learned about common scams and essential protection
                tips. By understanding these threats, you're much better
                equipped to defend yourself online. Click below to mark this
                important topic as complete!
              </p>
              {!completed && (
                <button
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-6">
                  <div className="flex items-center gap-4">
                    <div
                      className={`p-3 ${selectedScam.color} brutalist-border`}
                    >
