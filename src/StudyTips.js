          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl md:text-2xl font-bold text-gray-800 max-w-4xl mx-auto">
                Master the art of online research and boost your academic
                success! 📚
              </p>
                  ...
                  <div className="space-y-6">
                    ...
                    {selectedStrategy.techniques && (
                      <div className="bg-orange-500-50 brutalist-border p-4">
                        <h4 className="font-black text-lg mb-3 text-orange-500-600">
                          ⏰ TIME MANAGEMENT TECHNIQUES:
                        </h4>
                        <ul className="space-y-2">
                          {selectedStrategy.techniques.map(
                            (technique, index) => (
                              <li
                                key={index}
                                className="flex items-center gap-2 font-bold"
