...
const scenarios = [
  {
    id: 1,
    situation:
      "Your friend posts an embarrassing photo of you without asking. What do you do?",
    options: [
      {
        text: "Post an embarrassing photo of them back",
        correct: false,
        feedback: "This creates more problems and escalates the situation!",
      },
      {
        text: "Ask them politely to take it down",
        correct: true,
        feedback: "Perfect! Direct, respectful communication is always best.",
      },
      {
        text: "Ignore it and hope it goes away",
        correct: false,
        feedback: "Your feelings matter! It's okay to speak up for yourself.",
      },
      {
        text: "Report them immediately",
        correct: false,
        feedback:
          "Try talking to them first - they might not realize it bothered you.",
      },
    ],
  },
  {
    id: 2,
    situation:
      "Someone in a group chat is making racist jokes. What should you do?",
    options: [
      {
        text: "Leave the group chat quietly",
        correct: false,
        feedback: "While leaving is okay, speaking up helps create change.",
      },
      {
        text: "Laugh along to fit in",
        correct: false,
        feedback:
          "Never compromise your values to fit in - that's not worth it.",
      },
      {
        text: "Tell them it's not okay and ask them to stop",
        correct: true,
        feedback:
          "Yes! Standing up for what's right takes courage but makes a difference.",
      },
      {
        text: "Share the screenshots publicly to shame them",
        correct: false,
        feedback:
          "Public shaming isn't the right approach - try direct communication first.",
      },
    ],
  },
];
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <div className="inline-block mb-6">
                <div className="w-20 h-20 bg-hot-pink brutalist-border brutalist-shadow flex items-center justify-center transform rotate-3">
              ...
              <p className="text-xl md:text-2xl font-bold text-gray-800 max-w-4xl mx-auto">
                Learn how to be respectful, kind, and safe in online
                communities! 🤝
              </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {netiquetteRules.map((rule, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`inline-block p-4 ${rule.color} brutalist-border brutalist-shadow-small mb-4`}
                        >
                        ...
                        <div className="flex items-center gap-2 font-black text-hot-pink">
                          SEE EXAMPLES
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="bg-white brutalist-border p-6 mb-6">
                    ...
                    <div className="space-y-3">
                      {scenarios[currentScenario].options.map(
                        (option, index) => (
                          <button
                            key={index}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white brutalist-border p-6 text-center">
                    ...
                    <p className="font-bold text-sm">
                      Create the kind of online world you want to live in
                    </p>
                  </div>
                  <div className="bg-white brutalist-border p-6 text-center">
                    <h3 className="font-black mb-3">SPEAK UP</h3>
                    <p className="font-bold text-sm">
                      Don't be a bystander - help make the internet safer
                    </p>
                  </div>
                  <div className="bg-white brutalist-border p-6 text-center">
            ...
            {currentStep === 3 && (
              <div className="text-center py-16">
                <h2 className="text-4xl font-black text-center mb-4">
                  YOU'RE A GREAT DIGITAL CITIZEN!
                </h2>
                <p className="font-bold text-lg text-center max-w-3xl mx-auto mb-8">
                  You know how to treat others with kindness and respect online.
                  Keep it up!
                </p>
                {!completed && (
                  <button
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center gap-4">
                      <div
                        className={`p-3 ${selectedRule.color} brutalist-border`}
                      >
