...
import { Eye, Search, Users, Clock, ExternalLink, CheckCircle2, X, AlertTriangle, ArrowLeft, ArrowRight } from "lucide-react";
...
const misinfoTypes = [
  {
    ...
    color: "bg-red-500",
    example: {
      headline: "SCIENTISTS DISCOVER CURE FOR ALL DISEASES (DOCTORS HATE THIS!)",
      source: "healthtruth.blogspot.com",
      issues: ["Clickbait headline", "Unreliable source", "Too good to be true", "No author credited"]
    }
  },
  {
    ...
    example: {
      ...
      issues: ["No date/location info", "Suspicious quality", "Reverse image search shows original"]
    }
  },
  {
    id: "social-rumors",  
    title: "SOCIAL MEDIA RUMORS",
    description: "Unverified claims that spread quickly through social networks",
    icon: Users,
    color: "bg-purple-500",
    example: {
      ...
      issues: ["Third-hand information", "No evidence provided", "Appeals to fear", "Anonymous source"]
    }
  },
  {
    id: "outdated-info",
    ...
    example: {
      ...
      issues: ["No current date", "Emotional language", "Lack of recent sources"]
    }
  }
];
...
const verificationSteps = [
  {
    ...
    description: "Look for author name, publication date, and reputable website",
    icon: Search
  },
  {
    step: 2, 
  ...
  },
  {
    ...
    description: "Look for photos, videos, data, or expert quotes that support claims",
    icon: Eye
  },
  {
    step: 4,
    title: "CHECK YOUR BIAS",
    description: "Ask yourself: Do I want this to be true? Am I being objective?",
    icon: AlertTriangle
  }
];
...
const reliableSources = [
  ...
  "Scientific journals", "Government websites (.gov)",
  "Established newspapers", "Fact-checking sites (Snopes, FactCheck.org)"
];
...
export default function MisinformationPage() {
  ...
  const quizQuestions = [
    {
      question: "You see a shocking news headline on social media. What should you do FIRST?",
      options: [
    ...
    {
      question: "A news article has no author name and was published on 'truthnews.info'. This is:",
      options: [
        "Completely normal",
      ...
      correct: 1,
      explanation: "Legitimate news always credits authors and comes from established sources."
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-black mb-4 transform -rotate-1">
            SPOT FAKE
            <span className="block text-orange-500 transform rotate-2">NEWS!</span>
          </h1>
          
          <p className="text-xl md:text-2xl font-bold text-gray-800 max-w-4xl mx-auto">
            Learn how to identify misinformation and verify what you read online! 🔍
          </p>
          ...
          <div className="bg-blue-50 brutalist-border brutalist-shadow p-8 mb-12 transform -rotate-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {verificationSteps.map((step, index) => (
                <div key={step.step} className="bg-white brutalist-border p-6 text-center transform hover:scale-105 transition-transform">
                  ...
                  <p className="font-bold text-gray-700 text-sm">{step.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-lime-500 brutalist-border brutalist-shadow p-8 mb-12 transform rotate-1">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {reliableSources.map((source, index) => (
                <div key={index} className="bg-white brutalist-border p-4 text-center transform hover:scale-105 transition-transform">
        ...
        {currentStep === 4 && (
          <div className="text-center py-16">
            <h2 className="text-4xl font-black text-center mb-4">YOU'RE A FACT-CHECKER!</h2>
            <p className="font-bold text-lg text-center max-w-3xl mx-auto mb-8">
              You now have the tools to tell fact from fiction online. Great job!
            </p>
            {!completed && (
              <button
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-4">
                  <div className={`p-3 ${selectedExample.color} brutalist-border`}>
                    <selectedExample.icon className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-2xl font-black">{selectedExample.title}</h3>
                </div>
                <button
              ...
              <div className="space-y-6">
                ...
                <div className="bg-yellow-50 brutalist-border p-4">
                  <h4 className="font-black text-lg mb-3 text-yellow-600">🚩 WARNING SIGNS:</h4>
